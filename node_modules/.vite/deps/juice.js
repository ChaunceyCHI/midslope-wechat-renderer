...
var defaultOpts$2, DomHandler;
var init_esm$7 = __esmMin((() => {
	init_esm$8();
	init_node();
	init_node();
	defaultOpts$2 = {
...
var xmlReplacer, xmlCodeMap, getCodePoint$1, escapeAttribute$1, escapeText$1;
var init_escape$1 = __esmMin((() => {
	...
	getCodePoint$1 = String.prototype.codePointAt != null ? (str, index) => str.codePointAt(index) : (c, index) => (c.charCodeAt(index) & 64512) === 55296 ? (c.charCodeAt(index) - 55296) * 1024 + c.charCodeAt(index + 1) - 56320 + 65536 : c.charCodeAt(index);
	escapeAttribute$1 = getEscaper$1(/["&\u00A0]/g, new Map([
		[34, "&quot;"],
		[38, "&amp;"],
		[160, "&nbsp;"]
	]));
	escapeText$1 = getEscaper$1(/[&<>\u00A0]/g, new Map([
		[38, "&amp;"],
		[60, "&lt;"],
		[62, "&gt;"],
		[160, "&nbsp;"]
...
//#endregion
//#region node_modules/dom-serializer/node_modules/entities/lib/esm/index.js
var EntityLevel, EncodingMode;
var init_esm$6 = __esmMin((() => {
	init_escape$1();
...
var init_foreignNames = __esmMin((() => {
...
var init_manipulation$1 = __esmMin((() => {}));
//#endregion
...
var init_options = __esmMin((() => {
	defaultOpts$1 = { _useHtmlParser2: false };
}));
//#endregion
...
function getAttr(elem, name, xmlMode) {
	...
	if (hasOwn.call(elem.attribs, name)) return !xmlMode && rboolean.test(name) ? name : elem.attribs[name];
...
function prop(name, value) {
	...
	if (typeof name === "string" && value === void 0) {
		...
		switch (name) {
			...
			case "tagName":
			case "nodeName": return el.name.toUpperCase();
			case "href":
			case "src": {
			...
			default: return getProp(el, name, this.options.xmlMode);
		}
	}
	if (typeof name === "object" || value !== void 0) {
		if (typeof value === "function") {
...
function readAllData(el) {
	for (const domName of Object.keys(el.attribs)) {
		...
		if (!hasOwn.call(el.data, jsName)) el.data[jsName] = parseDataValue(el.attribs[domName]);
	}
	return el.data;
}
/**
...
function readData(el, name) {
	...
	const data = el.data;
	if (hasOwn.call(data, name)) return data[name];
	if (hasOwn.call(el.attribs, domName)) return data[name] = parseDataValue(el.attribs[domName]);
}
/**
...
function toggleClass(value, stateVal) {
	...
	for (let i = 0; i < numElements; i++) {
		...
		for (let j = 0; j < numClasses; j++) {
			...
			else if (state <= 0 && index >= 0) elementClasses.splice(index, 1);
		}
...
function parseSelector(subselects, selector, selectorIndex) {
	...
	function stripWhitespace(offset) {
		...
		while (selectorIndex < selector.length && isWhitespace$2(selector.charCodeAt(selectorIndex))) selectorIndex++;
	}
			...
			case 91: {
				...
				if (action !== "exists") {
					if (isQuote(selector.charCodeAt(selectorIndex))) {
						...
						while (selectorIndex < selector.length && (!isWhitespace$2(selector.charCodeAt(selectorIndex)) && selector.charCodeAt(selectorIndex) !== 93 || isEscaped(selectorIndex))) selectorIndex += 1;
...
//#endregion
//#region node_modules/css-what/lib/es/index.js
...
var import_boolbase$6, reChars, caseInsensitiveAttributes, attributeRules;
var init_attributes = __esmMin((() => {
	import_boolbase$6 = /* @__PURE__ */ __toESM(require_boolbase(), 1);
	reChars = /[-[\]{}()*+?.,\\^$|#\s]/g;
	...
	attributeRules = {
		...
		element(next, data, options) {
			...
			if (/\s/.test(value)) return import_boolbase$6.default.falseFunc;
		...
		start(next, data, options) {
			...
			let { value } = data;
			const len = value.length;
			if (len === 0) return import_boolbase$6.default.falseFunc;
			if (shouldIgnoreCase(data, options)) {
				value = value.toLowerCase();
				return (elem) => {
					const attr = adapter.getAttributeValue(elem, name);
		...
		any(next, data, options) {
			const { adapter } = options;
			const { name, value } = data;
			if (value === "") return import_boolbase$6.default.falseFunc;
			if (shouldIgnoreCase(data, options)) {
...
function compile$2(parsed) {
	const a = parsed[0];
	const b = parsed[1] - 1;
	if (b < 0 && a <= 0) return import_boolbase$5.default.falseFunc;
	if (a === -1) return (index) => index <= b;
	if (a === 0) return (index) => index === b;
	if (a === 1) return b < 0 ? import_boolbase$5.default.trueFunc : (index) => index >= b;
	const absA = Math.abs(a);
	const bMod = (b % absA + absA) % absA;
	return a > 1 ? (index) => index >= b && index % absA === bMod : (index) => index <= b && index % absA === bMod;
}
var import_boolbase$5;
var init_compile$1 = __esmMin((() => {
	import_boolbase$5 = /* @__PURE__ */ __toESM(require_boolbase(), 1);
}));
//#endregion
...
function dynamicStatePseudo(name) {
	return function dynamicPseudo(next, _rule, { adapter }) {
		...
		if (typeof func !== "function") return import_boolbase$4.default.falseFunc;
		return function active(elem) {
			return func(elem) && next(elem);
		};
	};
}
var import_boolbase$4, filters;
var init_filters = __esmMin((() => {
	init_esm$3();
	import_boolbase$4 = /* @__PURE__ */ __toESM(require_boolbase(), 1);
	filters = {
		...
		"nth-child"(next, rule, { adapter, equals }) {
			...
			if (func === import_boolbase$4.default.falseFunc) return import_boolbase$4.default.falseFunc;
			if (func === import_boolbase$4.default.trueFunc) return getChildFunc(next, adapter);
...
function ensureIsTag(next, adapter) {
	if (next === import_boolbase$3.default.falseFunc) return import_boolbase$3.default.falseFunc;
...
var import_boolbase$3, PLACEHOLDER_ELEMENT, is$2, subselects;
var init_subselects = __esmMin((() => {
	import_boolbase$3 = /* @__PURE__ */ __toESM(require_boolbase(), 1);
	init_sort();
	PLACEHOLDER_ELEMENT = {};
	is$2 = (next, token, options, context, compileToken) => {
		const func = compileToken(token, copyOptions(options), context);
		return func === import_boolbase$3.default.trueFunc ? next : func === import_boolbase$3.default.falseFunc ? import_boolbase$3.default.falseFunc : (elem) => func(elem) && next(elem);
	};
	subselects = {
		is: is$2,
		/**
		...
		*/
		...
		not(next, token, options, context, compileToken) {
			const func = compileToken(token, copyOptions(options), context);
			return func === import_boolbase$3.default.falseFunc ? next : func === import_boolbase$3.default.trueFunc ? import_boolbase$3.default.falseFunc : (elem) => !func(elem) && next(elem);
		},
		has(next, subselect, options, _context, compileToken) {
			...
			if (compiled === import_boolbase$3.default.falseFunc) return import_boolbase$3.default.falseFunc;
			const hasElement = ensureIsTag(compiled, adapter);
			if (context && compiled !== import_boolbase$3.default.trueFunc) {
...
var init_pseudo_selectors = __esmMin((() => {
	init_es();
	init_filters();
	init_pseudos();
	init_aliases();
...
function compileToken(token, options, context) {
	...
	}).reduce(reduceRules, import_boolbase$2.default.falseFunc);
	query.shouldTestNextSiblings = shouldTestNextSiblings;
	return query;
}
function compileRules(rules, options, context) {
	var _a;
	return rules.reduce((previous, rule) => previous === import_boolbase$2.default.falseFunc ? import_boolbase$2.default.falseFunc : compileGeneralSelector(previous, rule, options, context, compileToken), (_a = options.rootFunc) !== null && _a !== void 0 ? _a : import_boolbase$2.default.trueFunc);
}
function reduceRules(a, b) {
	if (b === import_boolbase$2.default.falseFunc || a === import_boolbase$2.default.trueFunc) return a;
	if (a === import_boolbase$2.default.falseFunc || b === import_boolbase$2.default.trueFunc) return b;
	return function combine(elem) {
		return a(elem) || b(elem);
	};
}
var import_boolbase$2, DESCENDANT_TOKEN, FLEXIBLE_DESCENDANT_TOKEN, SCOPE_TOKEN;
var init_compile = __esmMin((() => {
	init_es();
	import_boolbase$2 = /* @__PURE__ */ __toESM(require_boolbase(), 1);
	init_sort();
	init_general();
	init_subselects();
...
var defaultEquals, defaultOptions, _compileToken;
...
var import_boolbase, UNIVERSAL_SELECTOR, SCOPE_PSEUDO;
var init_esm$1 = __esmMin((() => {
	init_es();
	init_esm$2();
	init_esm$4();
	import_boolbase = /* @__PURE__ */ __toESM(require_boolbase());
	init_helpers();
	init_positionals();
	UNIVERSAL_SELECTOR = {
		type: SelectorType.Universal,
...
var init_traversing = __esmMin((() => {
	...
	parent = _singleMatcher(({ parent }) => parent && !isDocument(parent) ? parent : null, _removeDuplicates);
	...
	parentsUntil = _matchUntil(({ parent }) => parent && !isDocument(parent) ? parent : null, uniqueSort, (elems) => elems.reverse());
	...
	siblings = _matcher((elem) => getSiblings(elem).filter((el) => isTag(el) && el !== elem), uniqueSort);
	children = _matcher((elem) => getChildren(elem).filter(isTag), _removeDuplicates);
}));
//#endregion
...
var append, prepend, wrap, wrapInner;
var init_manipulation = __esmMin((() => {
	...
	init_utils();
	init_esm$4();
	append = _insert((dom, children, parent) => {
		uniqueSplice(children, children.length, 0, dom, parent);
	});
	prepend = _insert((dom, children, parent) => {
...
var UNDEFINED_CODE_POINTS, CODE_POINTS, SEQUENCES;
var init_unicode = __esmMin((() => {
...
var init_preprocessor = __esmMin((() => {
	init_unicode();
	init_error_codes();
...
var decodeMap$1;
var init_decode_codepoint$1 = __esmMin((() => {
	decodeMap$1 = new Map([
		[0, 65533],
		[128, 8364],
		[130, 8218],
...
var CharCodes$2, TO_LOWER_BIT$1, BinTrieFlags$1, EntityDecoderState$1, DecodingMode$1, EntityDecoder$1;
var init_decode$1 = __esmMin((() => {
	init_decode_codepoint$1();
	init_decode_data_html$1();
	(function(CharCodes) {
		...
		*/
		stateNumericHex(input, offset) {
			...
			while (offset < input.length) {
				...
				if (isNumber$1(char) || isHexadecimalCharacter$1(char)) offset += 1;
				else {
...
var State$1, TokenizerMode, Tokenizer$1;
	...
	Tokenizer$1 = class {
		constructor(options, handler) {
			...
			*/
			...
			this.entityDecoder = new EntityDecoder$1(htmlDecodeTree, (cp, consumed) => {
		...
		_startCharacterReference() {
			...
			this.entityDecoder.startEntity(this._isCharacterReferenceInAttribute() ? DecodingMode$1.Attribute : DecodingMode$1.Legacy);
		}
		...
		_stateRcdataLessThanSign(cp) {
			if (cp === CODE_POINTS.SOLIDUS) this.state = State$1.RCDATA_END_TAG_OPEN;
			else {
				this._emitChars("<");
		...
		_stateRawtextLessThanSign(cp) {
			if (cp === CODE_POINTS.SOLIDUS) this.state = State$1.RAWTEXT_END_TAG_OPEN;
			else {
				this._emitChars("<");
		...
		_stateScriptDataEscapedLessThanSign(cp) {
			if (cp === CODE_POINTS.SOLIDUS) this.state = State$1.SCRIPT_DATA_ESCAPED_END_TAG_OPEN;
		...
		_stateMarkupDeclarationOpen(cp) {
			...
			} else if (this._consumeSequenceIfMatch(SEQUENCES.CDATA_START, true)) if (this.inForeignNode) this.state = State$1.CDATA_SECTION;
			else {
		...
		_stateCommentLessThanSignBang(cp) {
			if (cp === CODE_POINTS.HYPHEN_MINUS) this.state = State$1.COMMENT_LESS_THAN_SIGN_BANG_DASH;
			else {
				this.state = State$1.COMMENT;
				this._stateComment(cp);
			}
		...
		_stateCommentLessThanSignBangDash(cp) {
			if (cp === CODE_POINTS.HYPHEN_MINUS) this.state = State$1.COMMENT_LESS_THAN_SIGN_BANG_DASH_DASH;
			else {
				this.state = State$1.COMMENT_END_DASH;
				this._stateCommentEndDash(cp);
			}
		...
		_stateAfterDoctypeName(cp) {
			...
			switch (cp) {
				...
				case CODE_POINTS.EOF:
					...
					this._emitEOFToken();
					break;
				default: if (this._consumeSequenceIfMatch(SEQUENCES.PUBLIC, false)) this.state = State$1.AFTER_DOCTYPE_PUBLIC_KEYWORD;
				else if (this._consumeSequenceIfMatch(SEQUENCES.SYSTEM, false)) this.state = State$1.AFTER_DOCTYPE_SYSTEM_KEYWORD;
				else if (!this._ensureHibernation()) {
		...
		_stateCdataSectionBracket(cp) {
			if (cp === CODE_POINTS.RIGHT_SQUARE_BRACKET) this.state = State$1.CDATA_SECTION_END;
			else {
				this._emitChars("]");
		...
		_stateCharacterReference() {
			...
			if (length === 0) {
				...
				this.state = !this._isCharacterReferenceInAttribute() && isAsciiAlphaNumeric$1(this.preprocessor.peek(1)) ? State$1.AMBIGUOUS_AMPERSAND : this.returnState;
			} else this.state = this.returnState;
		}
		_stateAmbiguousAmpersand(cp) {
			if (isAsciiAlphaNumeric$1(cp)) this._flushCodePointConsumedAsCharacterReference(cp);
			else {
...
var init_open_element_stack = __esmMin((() => {
	init_html();
	...
	SCOPING_ELEMENTS_HTML_BUTTON = new Set([...SCOPING_ELEMENTS_HTML, TAG_ID.BUTTON]);
	SCOPING_ELEMENTS_MATHML = new Set([
...
var init_formatting_element_list = __esmMin((() => {
	NOAH_ARK_CAPACITY = 3;
	(function(EntryType) {
...
var init_foreign_content = __esmMin((() => {
	init_html();
	MIME_TYPES = {
		TEXT_HTML: "text/html",
...
var HIDDEN_INPUT_TYPE, AA_OUTER_LOOP_ITER, AA_INNER_LOOP_ITER, InsertionMode, BASE_LOC, TABLE_STRUCTURE_TAGS, defaultParserOptions, Parser$1, TABLE_VOID_ELEMENTS;
...
var escapeAttribute, escapeText;
...
var renderOpts;
var init_parse5_adapter = __esmMin((() => {
	init_esm$7();
	init_dist$1();
	init_dist();
...
//#endregion
//#region node_modules/htmlparser2/node_modules/entities/lib/esm/generated/decode-data-html.js
...
//#endregion
//#region node_modules/htmlparser2/node_modules/entities/lib/esm/generated/decode-data-xml.js
...
//#endregion
//#region node_modules/htmlparser2/node_modules/entities/lib/esm/decode_codepoint.js
/**
* Replace the given code point with a replacement character if it is a
* surrogate or is outside the valid range. Otherwise return the code
* point unchanged.
...
//#endregion
//#region node_modules/htmlparser2/node_modules/entities/lib/esm/decode.js
...
var CharCodes$1, TO_LOWER_BIT, BinTrieFlags, EntityDecoderState, DecodingMode, EntityDecoder;
...
var CharCodes, State, QuoteType, Sequences, Tokenizer;
var init_Tokenizer = __esmMin((() => {
	init_decode();
	(function(CharCodes) {
...
var parse, load;
var init_load_parse = __esmMin((() => {
	init_load();
	init_parse();
	init_parse5_adapter();
	init_esm$5();
	init_esm();
	parse = getParse((content, options, isDocument, context) => options._useHtmlParser2 ? parseDocument(content, options) : parseWithParse5(content, options, isDocument, context));
	load = getLoad(parse, (dom, options) => options._useHtmlParser2 ? render$1(dom, options) : renderWithParse5(dom));
}));
//#endregion
//#region node_modules/cheerio/dist/browser/index.js
...
//#endregion
//#region node_modules/mensch/lib/debug.js
...
//#endregion
//#region node_modules/mensch/lib/lexer.js
			...
			switch (ch) {
				...
				case ";":
					switch (getState()) {
						...
						case "before-value":
						case "value":
							if (buffer.trim().length > 0) token.value = buffer.trim(), addToken();
...
//#endregion
//#region node_modules/mensch/lib/parser.js
...
//#endregion
//#region node_modules/mensch/lib/stringify.js
...
//#endregion
//#region node_modules/mensch/index.js
var require_mensch = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = {
		lex: require_lexer(),
		parse: require_parser$1(),
		stringify: require_stringify()
	};
}));
//#endregion
//#region node_modules/slick/parser.js
var require_parser = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var replacer = function(rawMatch, separator, combinator, combinatorChildren, tagName, id, className, attributeKey, attributeOperator, attributeQuote, attributeValue, pseudoMarker, pseudoClass, pseudoQuote, pseudoClassQuotedValue, pseudoClassValue) {
		...
		if (tagName) current.tag = unescape(tagName);
		else if (id) current.id = unescape(id);
		else if (className) {
...
//#endregion
//#region node_modules/juice/lib/selector.js
		...
		function specificity(text, parsed) {
			...
			for (var i = 0; i < expressions.length; i++) {
				...
				if (pseudos) {
					...
					for (var p = 0; p < pseudos.length; p++) if (pseudos[p].name === "not") {
...
//#endregion
//#region node_modules/juice/lib/property.js
var require_property = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	...
	Property.prototype.compare = function(property) {
		if (this.compareFunc(property) === 1) return this;
		return property;
	};
	/**
...
//#endregion
//#region node_modules/juice/lib/utils.js
var require_utils = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	exports.parseCSS = function(css) {
		...
		if (rules.length > 0 && rules[0].type === "comment" && rules[0].text) {
			if (rules[0].text.trim() === "juice ignore") ignoreEntireFile = true;
		}
		if (ignoreEntireFile) return ret;
		for (var i = 0, l = rules.length; i < l; i++) {
			if (rules[i].type === "comment") {
				if (!rules[i].text) continue;
				var comment = rules[i].text.trim();
				if (comment === "juice start ignore") ignoring = true;
				else if (comment === "juice end ignore") ignoring = false;
				else if (comment === "juice ignore next") i++;
				continue;
			}
				...
				if (rule.declarations) {
					...
					for (var d = 0; d < rule.declarations.length; d++) {
						...
						if (decl.type === "comment" && decl.text) {
							if (decl.text.trim() === "juice ignore next") {
								skipNext = true;
								continue;
							}
						}
						...
						if (decl.type === "property") filteredDeclarations.push(decl);
					}
				}
				if (filteredDeclarations.length > 0) for (var ii = 0, ll = selectors.length; ii < ll; ii++) ret.push([selectors[ii], filteredDeclarations]);
			}
		}
		return ret;
	};
	...
	*/
	exports.getPreservedText = function(css, options, ignoredPseudos) {
		...
		var ignoreBlock = [];
		var ignoreEntireFile = false;
		var ignoredRuleIndices = /* @__PURE__ */ new Set();
		if (rules.length > 0 && rules[0].type === "comment" && rules[0].text) {
			if (rules[0].text.trim() === "juice ignore") ignoreEntireFile = true;
		}
		if (ignoreEntireFile) return "\n" + css + "\n";
		for (var i = 0; i < rules.length; i++) {
			if (rules[i].type === "comment" && rules[i].text) {
				var comment = rules[i].text.trim();
				if (comment === "juice ignore next" && i + 1 < rules.length) ignoredRuleIndices.add(i + 1);
			}
			if (rules[i].type === "rule" && rules[i].declarations) {
				for (var d = 0; d < rules[i].declarations.length; d++) if (rules[i].declarations[d].type === "comment" && rules[i].declarations[d].text) {
					if (rules[i].declarations[d].text.trim() === "juice ignore next") {
		...
		for (var i = rules.length - 1; i >= 0; i--) {
			...
			if (rule.type === "comment") {
				...
				if (comment === "juice end ignore") {
					...
					if (ignoreBlock.length > 0) {
						preserved.unshift(mensch.stringify({ stylesheet: { rules: ignoreBlock.reverse() } }, {
							comments: true,
							indentation: "  "
						}));
						ignoreBlock = [];
			...
			if (ignoredRuleIndices.has(i)) {
				preserved.unshift(mensch.stringify({ stylesheet: { rules: [rule] } }, {
					comments: true,
					indentation: "  "
				}));
				continue;
			}
			if (options.fontFaces && rule.type === "font-face" || options.mediaQueries && rule.type === "media" || options.keyFrames && rule.type === "keyframes" || options.pseudos && rule.selectors && this.matchesPseudo(rule.selectors[0], ignoredPseudos) || options.preservedSelectors && rule.selectors && rule.selectors.some(function(sel) {
	...
	*/
	exports.matchesPreservedSelector = function(selector, preservedSelectors) {
		if (!preservedSelectors || preservedSelectors.length === 0) return false;
	...
	*/
	exports.removeInlinedSelectorsFromCSS = function(css, inlinedSelectors, options, ignoredPseudos) {
		...
		return mensch.stringify({ stylesheet: { rules: remainingRules } }, {
			comments: false,
			indentation: "  "
		});
	};
...
//#endregion
//#region node_modules/juice/lib/cheerio.js
var require_cheerio = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* Module dependencies.
	*/
	...
	*/
	module.exports = function(html, options, callback, callbackExtraArguments) {
		...
		if (options && options.xmlMode) return entityConverters.decodeEntities(doc.xml());
...
//#endregion
//#region node_modules/entities/dist/commonjs/internal/decode-shared.js
...
//#endregion
//#region node_modules/entities/dist/commonjs/decode.js
		...
		*/
		stateNamedEntity(input, offset) {
			...
			while (offset < input.length) {
				...
				const char = input.charCodeAt(offset);
				if (char === CharCodes.SEMI && valueLength !== 0 && (current & bin_trie_flags_js_1.BinTrieFlags.FLAG13) !== 0) return this.emitNamedEntityData(this.treeIndex, valueLength, this.consumed + this.excess);
				this.treeIndex = determineBranch(decodeTree, current, this.treeIndex + Math.max(1, valueLength), char);
				if (this.treeIndex < 0) return this.result === 0 || this.decodeMode === DecodingMode.Attribute && (valueLength === 0 || isEntityInAttributeInvalidEnd(char)) ? 0 : this.emitNotTerminatedNamedEntity();
				current = decodeTree[this.treeIndex];
				valueLength = (current & bin_trie_flags_js_1.BinTrieFlags.VALUE_LENGTH) >> 14;
...
//#endregion
//#region node_modules/entities/dist/commonjs/escape.js
var require_escape = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.getCodePoint = String.prototype.codePointAt == null ? (c, index) => (c.charCodeAt(index) & 64512) === 55296 ? (c.charCodeAt(index) - 55296) * 1024 + c.charCodeAt(index + 1) - 56320 + 65536 : c.charCodeAt(index) : (input, index) => input.codePointAt(index);
	/**
	* Bitset for ASCII characters that need to be escaped in XML.
	*/
	exports.XML_BITSET_VALUE = 1342177476;
	/**
	* Encodes all non-ASCII characters, as well as characters not valid in XML
	...
	*/
	function encodeXML(input) {
		...
		for (let index = 0; index < length; index++) {
			...
			if (char < 128 && ((exports.XML_BITSET_VALUE >>> char & 1) === 0 || char >= 64 || char < 32)) continue;
...
//#endregion
//#region node_modules/entities/dist/commonjs/internal/encode-shared.js
var require_encode_shared = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/entities/dist/commonjs/index.js
var require_commonjs = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	function decodeStrict(input, options = EntityLevel.XML) {
		...
		(_a = normalizedOptions.mode) !== null && _a !== void 0 || (normalizedOptions.mode = decode_js_1.DecodingMode.Strict);
	...
	*/
	function encode(input, options = EntityLevel.XML) {
		...
		switch (mode) {
			case EncodingMode.UTF8: return (0, escape_js_1.escapeUTF8)(input);
			case EncodingMode.Attribute: return (0, escape_js_1.escapeAttribute)(input);
			case EncodingMode.Text: return (0, escape_js_1.escapeText)(input);
			case EncodingMode.ASCII: return level === EntityLevel.HTML ? (0, encode_js_1.encodeNonAsciiHTML)(input) : (0, escape_js_1.encodeXML)(input);
			case EncodingMode.Extensive:
			default: return level === EntityLevel.HTML ? (0, encode_js_1.encodeHTML)(input) : (0, escape_js_1.encodeXML)(input);
		}
	}
...
//#endregion
//#region node_modules/juice/lib/numbers.js
var require_numbers = /* @__PURE__ */ __commonJSMin(((exports) => {
	/**
...
//#endregion
//#region node_modules/juice/lib/variables.js
var require_variables = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	...
	var findVariableValue = (el, variable) => {
		while (el) {
			if (el.styleProps && variable in el.styleProps) return el.styleProps[variable].value;
...
//#endregion
//#region node_modules/juice/lib/inline.js
var require_inline = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var { decode } = require_commonjs();
	var utils = require_utils();
	...
	module.exports = function makeJuiceClient(juiceClient) {
		...
		juiceClient.widthElements = [
			"TABLE",
			"TD",
			"TH",
			"IMG"
		];
		juiceClient.heightElements = [
			"TABLE",
			"TD",
			"TH",
			"IMG"
		...
		function inlineDocument($, css, options) {
			...
			var counters = {};
			var inlinedSelectors = options.removeInlinedSelectors ? /* @__PURE__ */ new Set() : null;
			if (options.styleAttributeName) styleAttributeName = options.styleAttributeName;
			function handleRule(rule) {
				...
				for (var i = 0; i < parsedSelector.length; ++i) {
					...
					if (subSel.pseudos) for (var j = 0; j < subSel.pseudos.length; ++j) {
						var subSelPseudo = subSel.pseudos[j];
						if (juiceClient.ignoredPseudos.indexOf(subSelPseudo.name) >= 0) return;
					}
				}
				...
				var matchedElements = false;
				els.each(function() {
					var el = this;
					if (el.name && juiceClient.nonVisualElements.indexOf(el.name.toUpperCase()) >= 0) return;
					matchedElements = true;
					if (!el.counterProps) el.counterProps = el.parent && el.parent.counterProps ? Object.create(el.parent.counterProps) : {};
					if (pseudoElementType) {
					...
					if (!el.styleProps) {
						...
						if ($(el).attr(styleAttributeName)) {
							...
							var cssText = "* { " + (options.decodeStyleAttributes ? decode(styleAttributeValue) : styleAttributeValue) + " } ";
					...
					function incrementCounter(el, value) {
						...
						for (var j = 0; j < tokens.length; j++) {
							var counter = tokens[j];
							if (el.counterProps[counter] === void 0) continue;
					...
					function addProps(style, selector) {
						for (var i = 0, l = style.length; i < l; i++) if (style[i].type == "property") {
							...
							if (name === "counter-reset") resetCounter(el, value);
							if (name === "counter-increment") incrementCounter(el, value);
							...
							if (juiceClient.excludedProperties.indexOf(name) < 0) {
								if (options.inlineDuplicateProperties) if (existing) if (existing.selector === selector) {
									prop.nextProp = existing;
									el.styleProps[name] = prop;
								} else {
									var last = existing;
									while (last.nextProp) last = last.nextProp;
									last.nextProp = prop;
								}
								else el.styleProps[name] = prop;
								else if (existing && existing.compare(prop) === prop || !existing) {
									if (existing && existing.selector !== selector) delete el.styleProps[name];
									else if (existing) prop.nextProp = existing;
									el.styleProps[name] = prop;
								}
							}
						}
				...
				if (matchedElements && inlinedSelectors) inlinedSelectors.add(rule[0]);
			}
			function setStyleAttrs(el) {
				...
				var string = props.filter(function(prop) {
					if (options.resolveCSSVariables && prop.prop.indexOf("--") === 0) return false;
					return prop.prop !== "content";
				}).map(function(prop) {
					if (options.resolveCSSVariables) prop.value = variables.replaceVariables(el, prop.value);
					return prop.prop + ": " + prop.value.replace(/["]/g, "'") + ";";
				}).join(" ");
				if (string) $(el).attr(styleAttributeName, string);
			}
			function inlinePseudoElements(el) {
				if (el.pseudoElementType && el.styleProps.content) {
					...
					if (el.pseudoElementType === "before") $(parent).prepend(el);
			...
			function setDimensionAttrs(el, dimension) {
				...
				if (juiceClient[dimension + "Elements"].indexOf(elName) > -1) {
					for (var i in el.styleProps) if (el.styleProps[i].prop === dimension) {
						var value = el.styleProps[i].value;
						if (options.preserveImportant) value = removeImportant(value);
			...
			function setAttributesOnTableElements(el) {
				...
				if (juiceClient.tableElements.indexOf(elName) > -1) {
					for (var i in el.styleProps) if (styleProps.indexOf(el.styleProps[i].prop) > -1) {
						var prop = juiceClient.styleToAttribute[el.styleProps[i].prop];
						var value = el.styleProps[i].value;
						if (options.preserveImportant) value = removeImportant(value);
						if (prop === "background") value = extractBackgroundUrl(value);
						if (/(linear|radial)-gradient\(/i.test(value)) continue;
						$(el).attr(prop, value);
					}
				}
			}
			...
			if (options.inlinePseudoElements) editedElements.forEach(inlinePseudoElements);
			if (options.applyWidthAttributes) editedElements.forEach(function(el) {
				setDimensionAttrs(el, "width");
			});
			if (options.applyHeightAttributes) editedElements.forEach(function(el) {
				setDimensionAttrs(el, "height");
			});
			if (options.applyAttributesTableElements) editedElements.forEach(setAttributesOnTableElements);
			if (options.insertPreservedExtraCss && options.extraCss) {
				...
				if (preservedText) {
					var $appendTo = null;
					if (options.insertPreservedExtraCss !== true) $appendTo = $(options.insertPreservedExtraCss);
					else {
						$appendTo = $("head");
		...
		function applyCounterStyle(counter, style) {
			switch (style) {
				case "lower-roman": return numbers.romanize(counter).toLowerCase();
				case "upper-roman": return numbers.romanize(counter);
				case "lower-latin":
				case "lower-alpha": return numbers.alphanumeric(counter).toLowerCase();
				case "upper-latin":
				case "upper-alpha": return numbers.alphanumeric(counter);
		...
		function parseContent(el) {
			...
			if (imageUrlMatch) return { img: imageUrlMatch[1].replace(/^['"]|['"]$/g, "") };
			var parsed = [];
		...
		function getPseudoElementType(selector) {
			...
			if (!pseudos) return;
			for (var i = 0; i < pseudos.length; i++) if (isPseudoElementName(pseudos[i])) return pseudos[i].name;
		}
		...
		function juiceDocument($, options) {
			...
			var embedStyleElements = /* @__PURE__ */ new Set();
			if (options.removeInlinedSelectors && !options.removeStyleTags) $("style[data-embed]").each(function() {
				embedStyleElements.add(this);
			});
			var css = extractCssFromDocument($, options);
			css += "\n" + options.extraCss;
			var inlinedSelectors = inlineDocument($, css, options);
			if (inlinedSelectors && !options.removeStyleTags) updateStyleTags($, inlinedSelectors, options, embedStyleElements);
			return $;
		}
		function updateStyleTags($, inlinedSelectors, options, embedStyleElements) {
			$("style").each(function() {
				var styleElement = this;
				var styleDataList = styleElement.childNodes;
				if (styleDataList.length !== 1) return;
				if (embedStyleElements && embedStyleElements.has(styleElement)) return;
				var originalCss = styleDataList[0].nodeValue;
				var remainingCss = utils.removeInlinedSelectorsFromCSS(originalCss, inlinedSelectors, options, juiceClient.ignoredPseudos);
				if (remainingCss && remainingCss.trim()) styleElement.childNodes[0].nodeValue = remainingCss;
		...
		function getStylesData($, options) {
			...
			stylesList.each(function() {
				...
				if (options.applyStyleTags && $(styleElement).attr("data-embed") === void 0) results.push(styleData);
				if (options.removeStyleTags && $(styleElement).attr("data-embed") === void 0) {
					...
					if (preservedText) styleElement.childNodes[0].nodeValue = preservedText;
					else $(styleElement).remove();
				}
		...
		function extractCssFromDocument($, options) {
			return getStylesData($, options).join("\n");
		}
		return juiceClient;
	};
}));
//#endregion
//#region node_modules/juice/client.js
var require_client = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	var juiceClient = require_inline()(function(html, options) {
